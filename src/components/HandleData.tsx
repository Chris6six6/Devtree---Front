  ...
  return (
    <div className="space-y-6 text-white">
        ...
        <div className="mt-20 flex flex-col gap-6">
            {links.length ?
                links.map(link => (
                    <a className="bg-white px-5 py-2 flex items-center gap-5 rounded-lg" href={link.url} target="_blank" rel="noreferrer noopener" key={link.name}>
            ...
            : <p className="text-center">No hay links disponibles</p>
            }
        </div>
    </div>
  )
